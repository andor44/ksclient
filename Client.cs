  ...
  public class Client
	{
		...
		byte[] buf;
        private static const int COMPR_TYPE_NONE = 1;
        private static const int COMPR_TYPE_LZ4 = 2;

        private static const int IMG_TYPE_DEPTH = 1;
        private static const int IMG_TYPE_IMAGE = 2;
        private static const int IMG_TYPE_IR = 3;

        private static const int depth_bpp = 2;
        private static const int image_bpp = 3;
        private static const int ir_bpp = 1;
